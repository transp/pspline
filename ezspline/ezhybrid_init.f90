subroutine EZhybrid_init2(spline_o, n1, n2, hspline, ier, &
  ...
  do i = 1, 2
     ...
     spline_o%bcval1min(1:idim2) = 0.0_fp
     spline_o%bcval1max(1:idim2) = 0.0_fp
     ...
     spline_o%bcval2min(1:idim1) = 0.0_fp
     spline_o%bcval2max(1:idim1) = 0.0_fp
  ...
  if(spline_o%ibctype1(1).eq.-1) spline_o%x1max = ezspline_twopi
  ...
  if(spline_o%ibctype2(1).eq.-1) spline_o%x2max = ezspline_twopi
...
subroutine EZhybrid_init3(spline_o, n1, n2, n3, hspline, ier, &
  ...
  do i = 1, 2
     ...
     spline_o%bcval1min(1:idim2, 1:idim3) = 0.0_fp
     spline_o%bcval1max(1:idim2, 1:idim3) = 0.0_fp
     spline_o%ibctype1(i) = 0
     if(present(BCS1)) then
        select case(BCS1(i))
        case (-1)
     ...
     spline_o%bcval2min(1:idim1, 1:idim3) = 0.0_fp
     spline_o%bcval2max(1:idim1, 1:idim3) = 0.0_fp
     spline_o%ibctype2(i) = 0
     if(present(BCS2)) then
        select case(BCS2(i))
        case (-1)
     ...
     spline_o%bcval3min(1:idim1, 1:idim2) = 0.0_fp
     spline_o%bcval3max(1:idim1, 1:idim2) = 0.0_fp
  ...
  if(spline_o%ibctype3(1).eq.-1) spline_o%x3max = ezspline_twopi
