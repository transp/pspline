...
12 c(4,1) = c(3,3)
   c(3,1) = c(3,2) + c(3,3)
   c(2,1) =((c(3,2)+2._fp*c(3,1))*c(4,2)*c(3,3)+ &
        c(3,2)**2*c(4,3))/c(3,1)
   go to 19
...
16 c(4,1) = 2._fp
   c(3,1) = 1._fp
   c(2,1) = 3._fp*c(4,2) - c(3,2)/2._fp*c(2,1)
...
19 do m=2,l
     g = -c(3,m+1)/c(4,m-1)
     c(2,m) = g*c(2,m-1) + 3._fp*(c(3,m)*c(4,m+1)+c(3,m+1)*c(4,m))
     c(4,m) = g*c(3,m-1) + 2._fp*(c(3,m) + c(3,m+1))
   end do
...
21 if (n .eq. 3 .and. ibcbeg .eq. 0) go to 22
   ...
   !     left end point.
   g = c(3,n-1) + c(3,n)
   c(2,n) = ((c(3,n)+2._fp*g)*c(4,n)*c(3,n-1) &
...
22 c(2,n) = 2._fp*c(4,n)
   c(4,n) = 1._fp
   go to 28
   !     second derivative prescribed at right endpoint.
24 c(2,n) = 3._fp*c(4,n) + c(3,n)/2._fp*c(2,n)
   c(4,n) = 2._fp
   go to 28
...
40 c(2,j) = (c(2,j) - c(3,j)*c(2,j+1))/c(4,j)
   ...
   do i=2,n
     ...
     divdf3 = c(2,i-1) + c(2,i) - 2._fp*divdf1
     c(3,i-1) = 2._fp*(divdf1 - c(2,i-1) - divdf3)/dtau
     c(4,i-1) = (divdf3/dtau)*(6._fp/dtau)
   end do
   !
   return
